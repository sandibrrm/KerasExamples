// src/lib.rs
/*
 * Core library for KerasExamples
 */
...
#[derive(Debug)]
pub struct KerasExamplesProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KerasExamplesProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KerasExamples processing");
    
    let mut processor = KerasExamplesProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KerasExamplesProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KerasExamplesProcessor::new(false);
